...
HR<- c("06:00","07:00","10:00","11:00","11:30", "12:00", "14:00", "17:00")
...
g=(ggplot(df_h_orig, aes(Date, S1)) + geom_line(color='green') +
geom_line(aes(y=yp$y, col=yp$x), color='red', lwd = 1)+
  labs(title="Time Series of PV Solar Power",
       subtitle= paste(c("PV-S1","at Hour", hr), collapse = " "),
       y="Solar Power (MW)",
       color=NULL))
...
# 
# for (i in 1:8) {
# file_name = paste("PV_Lw_Hi_filter_", i, ".tiff", sep="")
# tiff(file_name)
# print(plot_list[[i]])
# dev.off()
# }
