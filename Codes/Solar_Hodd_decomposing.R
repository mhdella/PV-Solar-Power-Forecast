...
# decompose(Sl_pw.ts1, type = c("additive", "multiplicative"), filter = NULL)
decompose(Sl_pw.ts1, type = c("multiplicative"), filter = NULL)
decompose(Sl_pw.ts1, type = c("additive"), filter = NULL)
...
# decompose(Sh_pw.ts1, type = c("additive", "multiplicative"), filter = NULL)
decompose(Sh_pw.ts1, type = c("multiplicative"), filter = NULL)
decompose(Sh_pw.ts1, type = c("additive"), filter = NULL)
